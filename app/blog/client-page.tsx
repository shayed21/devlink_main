...
export default function BlogClientPage({ initialPosts, initialCategories, initialTags }: BlogClientPageProps) {
  const [posts] = useState<BlogPostMeta[]>(initialPosts);
  const [filteredPosts, setFilteredPosts] = useState<BlogPostMeta[]>(initialPosts);
