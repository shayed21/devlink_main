  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a1020] via-[#101726] to-[#0a1020] text-white overflow-x-hidden">
      ...
      <section className="relative min-h-[80vh] md:min-h-screen flex items-center justify-center overflow-hidden px-2 md:px-0 pt-20">
        ...
        >
          ...
          <motion.h1
            ...
            custom={1}
          >
            We Build <span className="bg-gradient-to-r from-[#2e5f97] to-[#2788e9] bg-clip-text text-transparent">Future-Ready</span> Software Without Borders
          </motion.h1>
          <motion.p
          ...
          >
            <Link href="/contact">
              <Button
                size="lg"
                className="bg-gradient-to-r from-blue-700 to-blue-500 hover:from-blue-800 hover:to-blue-600 hover:shadow-glow-lg shadow-lg px-12 py-6 rounded-2xl font-bold text-xl transition-all duration-300 hover-lift animate-gradient-shift"
              >
                Start Your Project
        ...
        >
          <div className="w-8 h-14 border-2 border-blue-400 rounded-full flex justify-center items-start glass-card">
            <div className="w-1.5 h-4 bg-gradient-to-r from-blue-700 to-blue-500 rounded-full mt-3 animate-pulse"></div>
          </div>
        </motion.div>
      </section>
              ...
              >
                {service.popular && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                    <Badge className="bg-gradient-to-r from-blue-700 to-blue-500 text-white px-4 py-1 shadow-lg">Most Popular</Badge>
                  </div>
                )}
                <div className="flex items-center space-x-4 mb-4">
                  <div className="bg-gradient-to-r from-blue-700 to-blue-500 rounded-xl p-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                ...
                <Link href="/services">
                  <Button className="w-full bg-gradient-to-r from-blue-700 to-blue-500 hover:shadow-glow transition-all duration-300 group mt-2">
                    Learn More
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            {features.map((feature, index) => (
              <motion.div
                ...
                custom={index}
              >
                <div className="bg-gradient-to-r from-blue-700 to-blue-500 rounded-full w-16 h-16 flex items-center justify-center mb-4 shadow-lg">
          ...
          >
            <div>
              ...
              <Link href="/about">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-blue-700 to-blue-500 hover:shadow-glow transition-all duration-300 group"
                >
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-700 to-blue-500 opacity-10 pointer-events-none"></div>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            <Link href="/contact">
              <Button
                size="lg"
                className="bg-gradient-to-r from-blue-700 to-blue-500 hover:shadow-glow-lg transition-all duration-300 text-xl px-12 py-6 group"
              >
