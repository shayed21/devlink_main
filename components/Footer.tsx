          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form onSubmit={handleNewsletterSubmit} className="max-w-lg mx-auto">
              <div className="flex gap-4">
                ...
                <Button 
                  type="submit"
                  className="bg-gradient-to-r from-blue-700 to-blue-500 hover:from-blue-800 hover:to-blue-600 hover:shadow-glow-lg transition-all duration-300 px-8 py-4 rounded-xl hover-lift"
                >
              ...
              <div className="lg:col-span-2">
                <Link href="/" className="flex items-center mb-6">
                  <Image 
                    ...
                    width={180} 
                    height={54}
                    className="w-44 h-14 object-contain hover:scale-105 transition-transform duration-200"
                  />
                </Link>
                ...
                <div className="flex space-x-5">
                  {socialLinks.map((social, index) => (
                    <a
                      ...
                      className="glass-card hover:bg-gradient-to-r hover:from-blue-700 hover:to-blue-500 p-4 rounded-xl transition-all duration-300 hover-lift hover:shadow-glow group"
